...
<div class="col-md-12">
      <div class="panel panel-primary">
        <div style="background: #66A2EE ; color:black"class ="panel-heading"><b><h1> Form Tambah Artikel </b></h1></div>
        <div class="panel-footer"></div>
<div  align="center">
<table align="center" border="2" width="50%">
<tr align="center">
</tr>
<form method="post" enctype="multipart/form-data" action="index.php?include=konfirmasi-tambah-artikel">
...
<td width="55%"><input type="text" class="form-control" name="id" value=""/></td>
</tr>
<tr>
...
<td width="5%" align="center">:</td>
<td width="55%"><textarea name="posting" class="form-control" name="posting" value=""></textarea></td>
</tr>
<tr>
<td width="20%">Foto</td>
<td width="5%" align="center">:</td>
