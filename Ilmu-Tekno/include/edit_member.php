...
//get data member
$sql_p = "select `nama`,`email`,`alamat`,`id_status`,`no_telp`
...
<div class="col-md-12">
      <div class="panel panel-primary">
        <div style="background: #66A2EE ; color:black"class ="panel-heading"><b><h1> Form Edit Member </b></h1></div>
        <div class="panel-footer"></div>
<div  align="center">
<table align="center" border="2" width="50%">
<tr align="center">
</tr>
<form method="post" enctype="multipart/form-data" action="index.php?include=konfirmasi-edit-member">
...
<td width="55%"><input type="text" class="form-control" name="id_member"
value="<?php echo $id_member; ?>" readonly="readonly"/></td>
</tr>
<tr>
<td width="20%">Nama</td>
<td width="5%" align="center">:</td>
...
<td width="5%" align="center">:</td>
<td width="55%"><input type="text" class="form-control" name="alamat"
...
<?php $sql_pk = "select `id_status`,`status` from `status` order by `id_status`";
$query_pk = mysqli_query($koneksi,$sql_pk);
while($data_pk = mysqli_fetch_row($query_pk)){
$id_status = $data_pk[0];
$status= $data_pk[1];
?>
<option class="form-control" value="<?php echo $id_status;?>"
<?php if($id_status==$id_stats){?>selected="selected"<?php }?>>
...
<td width="5%" align="center">:</td>
<td width="55%"><input type="text" class="form-control" name="telepon"
